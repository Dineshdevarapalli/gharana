...
`;function se({children:a,...r}){return e.createElement(ce,{as:"button",background:"neutral0",border:"neutral150",paddingBottom:3,paddingLeft:4,paddingRight:4,paddingTop:3,shadow:"filterShadow",...r},e.createElement(c.k,{gap:2},e.createElement(Y,{"aria-hidden":!0}),e.createElement(P.Z,{variant:"pi",fontWeight:"bold",textColor:"neutral500"},a)))}se.propTypes={children:h().node.isRequired};var ge=t(63237),le=t(48734),ie=t(74756),J=t(12028),ke=t(63081),Ce=t(11276),ve=t(67819),be=t(16364),we=t(70642),De=t(20022),$e=t(12814),We=t(61080),Re=t(75642),Pe=t(13920),ue=t(13037);const Te=(0,ue.s)();function je(){return e.createElement(W.x,{background:"primary100",borderStyle:"dashed",borderColor:"primary600",borderWidth:"1px",display:"block",hasRadius:!0,padding:6,shadow:"tableShadow"})}function ye({id:a,index:r,canDelete:o,canReorder:b,isOpen:p=!1,stagesCount:m}){const d=u=>`${u+1} of ${m}`,M=u=>{z(D({id:"dnd.grab-item",defaultMessage:"{item}, grabbed. Current position in list: {position}. Press up and down arrow to change position, Spacebar to drop, Escape to cancel."},{item:$.value,position:d(u)}))},U=u=>{z(D({id:"dnd.drop-item",defaultMessage:"{item}, dropped. Final position in list: {position}."},{item:$.value,position:d(u)}))},pe=()=>{z(D({id:"dnd.cancel-item",defaultMessage:"{item}, dropped. Re-order cancelled."},{item:$.value}))},N=(u,ae)=>{z(D({id:"dnd.reorder",defaultMessage:"{item}, moved. New position in list: {position}."},{item:$.value,position:d(u)})),G(B(ae,u))},[de,z]=e.useState(null),{formatMessage:D}=(0,j.Z)(),{trackUsage:_}=(0,v.rS)(),G=(0,i.I0)(),[V,he]=e.useState(p),[$,fe]=(0,k.U$)(`stages.${r}.name`),[O,ee]=(0,k.U$)(`stages.${r}.color`),[{handlerId:A,isDragging:te,handleKeyDown:H},Ge,Ve,He,Se]=(0,Re.Y9)(b,{index:r,item:{name:$.value},onGrabItem:M,onDropItem:U,onMoveItem:N,onCancel:pe,type:s.uL.STAGE}),Qe=(0,Pe.FE)(Ge,Ve),Xe=Te.map(({hex:u,name:ae})=>({value:u,label:D({id:"Settings.review-workflows.stage.color.name",defaultMessage:"{name}"},{name:ae}),color:u}));e.useEffect(()=>{Se((0,We.rX)(),{captureDraggingState:!1})},[Se,r]);const{themeColorName:Ye}=O.value?(0,ue.k)(O.value):{};return e.createElement(W.x,{ref:Qe},de&&e.createElement(ge.T,{"aria-live":"assertive"},de),te?e.createElement(je,null):e.createElement(le.U,{size:"S",variant:"primary",onToggle:()=>{he(!V),V||_("willEditStage")},expanded:V,shadow:"tableShadow"},e.createElement(ie.B,{title:$.value,togglePosition:"left",action:e.createElement(c.k,null,o&&e.createElement(J.h,{background:"transparent",icon:e.createElement(De.Z,null),label:D({id:"Settings.review-workflows.stage.delete",defaultMessage:"Delete stage"}),noBorder:!0,onClick:()=>G(K(a))}),e.createElement(J.h,{background:"transparent",forwardedAs:"div",role:"button",noBorder:!0,tabIndex:0,"data-handler-id":A,ref:He,label:D({id:"Settings.review-workflows.stage.drag",defaultMessage:"Drag"}),onClick:u=>u.stopPropagation(),onKeyDown:H},e.createElement($e.Z,null)))}),e.createElement(ke.v,{padding:6,background:"neutral0",hasRadius:!0},e.createElement(Ce.r,{gap:4},e.createElement(ve.P,{col:6},e.createElement(be.o,{...$,id:$.name,label:D({id:"Settings.review-workflows.stage.name.label",defaultMessage:"Stage name"}),error:fe.error??!1,onChange:u=>{$.onChange(u),G(I(a,{name:u.target.value}))},required:!0})),e.createElement(ve.P,{col:6},e.createElement(we.q4,{error:ee?.error??!1,id:O.name,required:!0,label:D({id:"content-manager.reviewWorkflows.stage.color",defaultMessage:"Color"}),onChange:u=>{O.onChange({target:{value:u}}),G(I(a,{color:u}))},value:O.value.toUpperCase(),startIcon:e.createElement(c.k,{as:"span",height:2,background:O.value,borderColor:Ye==="neutral0"?"neutral150":"transparent",hasRadius:!0,shrink:0,width:2})},Xe.map(({value:u,label:ae,color:Me})=>{const{themeColorName:Je}=(0,ue.k)(Me);return e.createElement(we.ag,{value:u,key:u,startIcon:e.createElement(c.k,{as:"span",height:2,background:Me,borderColor:Je==="neutral0"?"neutral150":"transparent",hasRadius:!0,shrink:0,width:2})},ae)})))))))}ye.propTypes=h().shape({id:h().number.isRequired,color:h().string.isRequired,canDelete:h().bool.isRequired,canReorder:h().bool.isRequired,stagesCount:h().number.isRequired}).isRequired;const Ie=(0,L.ZP)(W.x)`
  position: relative;
`,Ae=(0,L.ZP)(W.x)`
  left: 50%;
  position: absolute;
...
`,Q=({children:i,disabled:n=!1,error:w,expanded:s=!1,hasErrorMessage:S=!0,id:K,onToggle:F,toggle:I,size:B="M",variant:c="primary",shadow:P})=>{const C=(0,y.M)(K),X=g.useMemo(()=>({expanded:s,onToggle:F,toggle:I,id:C,size:B,variant:c,disabled:n}),[n,s,C,F,B,I,c]);return(0,e.jsxs)(x.S.Provider,{value:X,children:[(0,e.jsx)(j,{"data-strapi-expanded":s,disabled:n,"aria-disabled":n,expanded:s,hasRadius:!0,variant:c,error:w,shadow:P,children:i}),w&&S&&(0,e.jsx)(v.x,{paddingTop:1,children:(0,e.jsx)(T.Z,{variant:"pi",textColor:"danger600",children:w})})]})}},63081:(E,f,t)=>{"use strict";t.d(f,{v:()=>x});var e=t(85893),g=t(13819),l=t(41580);const x=({children:y,...T})=>{const{expanded:Z,id:v}=(0,g.A)();if(!Z)return null;const R=`accordion-content-${v}`,k=`accordion-label-${v}`,j=`accordion-desc-${v}`;return(0,e.jsx)(l.x,{role:"region",id:R,"aria-labelledby":k,"aria-describedby":j,...T,children:y})}},13819:(E,f,t)=>{"use strict";t.d(f,{A:()=>l,S:()=>g});var e=t(67294);const g=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),l=()=>(0,e.useContext)(g)},74756:(E,f,t)=>{"use strict";t.d(f,{B:()=>i});var e=t(85893),g=t(12645),l=t(88972),x=t(48734),y=t(13819);const T=({expanded:n,disabled:w,variant:s})=>{let S="neutral100";return n?S="primary100":w?S="neutral150":s==="primary"&&(S="neutral0"),S};var Z=t(39785),v=t(52624),R=t(11047),k=t(75515);const j=(0,l.ZP)(Z.A)`
  text-align: left;
