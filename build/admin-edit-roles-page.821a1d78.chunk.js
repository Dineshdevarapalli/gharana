(self.webpackChunkart_gharana_api=self.webpackChunkart_gharana_api||[]).push([[2544],{23341:(X,B,r)=>{"use strict";r.r(B),r.d(B,{CreatePage:()=>Ee,default:()=>$e});var e=r(67294),b=r(185),P=r(53979),R=r(11047),Z=r(29728),O=r(49066),S=r(41580),x=r(75515),D=r(11276),q=r(67819),a=r(16364),H=r(61467),p=r(52358),A=r(67109),F=r(15104),f=r(41054),C=r(27361),w=r.n(C),ue=r(41609),ae=r.n(ue),ie=r(86896),y=r(86706),le=r(16550),Y=r(88972),G=r(35650),_=r(99369),xe=r(18280),me=r(87561);const oe=me.Ry().shape({name:me.Z_().required(p.I0.required),description:me.Z_().required(p.I0.required)}),Pe=Y.ZP.div`
